...
TrajectoryActionServer::TrajectoryActionServer(ros::NodeHandle* nodehandle):
	...
	as_(nh_, "hexarotor_mani", boost::bind(&TrajectoryActionServer::executeCB, this, _1), false)
{
	ROS_INFO("in constructor of TrajectoryActionServer...");
	as_.start(); // start the "hexarotor_mani_server"
}
...
int main(int argc, char** argv) {
	ros::init(argc, argv, "hexarotor_mani_server_node");
