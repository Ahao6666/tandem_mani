...
private:
	...
	void executeCB(const actionlib::SimpleActionServer<tandem_control::trajAction>::GoalConstPtr& goal);
	...
	actionlib::SimpleActionServer<tandem_control::trajAction> as_;
...
void TrajectoryActionServer::executeCB(const actionlib::SimpleActionServer<tandem_control::trajAction>::GoalConstPtr& goal) {
